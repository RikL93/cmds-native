...
export type IngestLogDetail = {
  ...
  lat?: number;
  lng?: number;
  // Doze / battery / OEM diagnostiek (Android-only).
  // Toegevoegd aan service_state events zodat we per stop direct kunnen zien
  // of het toestel toen in Doze stond of de battery-opt vrijstelling miste.
  dozeMode?: boolean;
